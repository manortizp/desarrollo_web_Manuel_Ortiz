...
La aplicación esta dividida en 4 .html: index, agregar-actividad, listado y estadistica y 2 .js: en particular, scripts está asociado a index y formulario está asociado a agregar-actividad. Además de una carpeta con los recursos visuales de la aplicación (images).
